...
class ClientPairFinalizePayload(DataClassORJSONMixin):
    ...
    long_term_psk: str
    """43-char base64url 32-byte PSK the client generated for this (client, server) pair."""
...
class ClientPairInitMessage(PairingMessage):
    ...
    payload: ClientPairInitPayload = field(default_factory=ClientPairInitPayload)
