...
class SendspinClient:
    ...
    def pairing_window(self) -> Callable[[], Awaitable[None]] | None:
        ...
        opens the pairing window. Its presence enables offering ``static_pin``.
        """
    ...
    def _should_admit_connection(self, incoming: SendspinConnection) -> bool:
        ...
        # An in-flight pairing is not displaced by an incoming playback or pairing.
        if admitted_rank == 1 and incoming_rank in (1, 2):
            return False
