...
class SendspinClient:
    ...
    def attach_connection(
        ...
        *,
        ...
        expected_role_ids = set(active_roles)

        # Reuse warm/cold-retained roles when the active role IDs are unchanged.
        can_reuse_roles = (
            self._roles_warm_disconnected or self._roles_cold_preinitialized
        ...
        if can_reuse_roles:
            ...
            # Create and register the active roles via registry.
