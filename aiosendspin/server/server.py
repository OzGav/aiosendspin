...
class SendspinServer:
    ...
    def __init__(
        ...
        *,
        ...
        self._unpaired_access_enabled = unpaired_access
    ...
    @property
    def unpaired_access_enabled(self) -> bool:
        """Whether this server is allowed to offer unpaired access."""
        return self._unpaired_access_enabled
    ...
    async def initiate_pairing(self, client_id: str, attempt: PairingAttempt) -> None:
        """Run an operator-initiated pairing exchange on a connected client."""
